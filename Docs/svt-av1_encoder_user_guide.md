...
`SvtAv1EncApp.exe -c Sample.cfg -i CrowdRun\_1920x1080.yuv -w 1920 -h 1080 --frames 100 --qp 30 --keyint 31 -o CrowdRun\_1920x1080\_qp30.bin`
...
`SvtAv1EncApp -i input.yuv -w 1920 -h 1080 --fps 24 --rc 0 --qp 30 --preset 8 -o output.ivf`

#### 1 pass VBR 10000 Kbps at medium speed from 24fps yuv 1920x1080 input
`SvtAv1EncApp -i input.yuv -w 1920 -h 1080 --fps 24 --rc 2 --tbr 10000 --preset 5 -o output.ivf`
...
| **FrameToBeEncoded** | --frames | [0 - 2^64 -1] | 0 | Number of frames to be encoded, if number of frames is > number of frames in file, the encoder will loop to the beginning and continue the encode. Use -1 to not buffer. |
...
| **IntraPeriod** | --keyint | [-2 - 255] | -2 | Distance Between Intra Frame inserted. -1 denotes no intra update. -2 denotes default. |
...
| **QP** | --qp | [0 - 63] | 50 | Quantization parameter used when RateControl is set to 0 |
...
| **Mfmv** | --enable-mfmv | [0/1, -1 for default] | DEFAULT | Enable motion field motion vector, 0 = OFF, 1 = ON, -1 = DEFAULT|
...
| **PruneUnipredMe** | --enable-prune-unipred-me | [0/1, -1 for default] | DEFAULT | Enable prune unipred at me, 0 = OFF, 1 = ON, -1 = DEFAULT|
