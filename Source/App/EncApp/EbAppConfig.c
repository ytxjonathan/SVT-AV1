...
ConfigEntry config_entry_global_options[] = {
    ...
    {SINGLE_INPUT, NULL, ENCODER_COLOR_FORMAT, "Encoder color format", set_encoder_color_format},
    {SINGLE_INPUT, NULL, PROFILE_TOKEN, "Bitstream profile number to use", set_profile},
    {SINGLE_INPUT, NULL, FRAME_RATE_TOKEN, "Stream frame rate (rate/scale)", set_frame_rate},
    {SINGLE_INPUT,
     NULL,
    ...
    {SINGLE_INPUT, NULL, ENCODER_BIT_DEPTH, "Bit depth for codec(8 or 10)", set_encoder_bit_depth},
    {SINGLE_INPUT, NULL, TIER_TOKEN, "Tier", set_tier},
    {SINGLE_INPUT, NULL, LEVEL_TOKEN, "Level", set_level},
    {SINGLE_INPUT, NULL, HIERARCHICAL_LEVELS_TOKEN, "Hierarchical levels", set_hierarchical_levels},
    {SINGLE_INPUT, NULL, PRED_STRUCT_TOKEN, "Prediction structure", set_cfg_pred_structure},
    {SINGLE_INPUT, NULL, LATENCY_MODE, "Latency mode", set_latency_mode},
    // Asm Type
    {SINGLE_INPUT,
     ASM_TYPE_TOKEN,
     NULL,
     ...
     set_asm_type},
    {SINGLE_INPUT, NULL, THREAD_MGMNT, "number of logical processors to be used", set_logical_processors},
    {SINGLE_INPUT,
     NULL,
     UNPIN_LP1_TOKEN,
    ...
    {SINGLE_INPUT, NULL, TARGET_SOCKET, "Specify  which socket the encoder runs on", set_target_socket},
    // Termination
    {SINGLE_INPUT, NULL, NULL, NULL, NULL}};
...
ConfigEntry config_entry_rc[] = {
    ...
    {SINGLE_INPUT, NULL, TARGET_BIT_RATE_TOKEN, "Target Bitrate (kbps)", set_target_bit_rate},
    {SINGLE_INPUT, NULL, MAX_QP_TOKEN, "Maximum (worst) quantizer", set_max_qp_allowed},
    {SINGLE_INPUT, NULL, MIN_QP_TOKEN, "Minimum (best) quantizer", set_min_qp_allowed},
    {SINGLE_INPUT, NULL, VBV_BUFSIZE_TOKEN, "VBV buffer size", set_vbv_buf_size},
    // Termination
    {SINGLE_INPUT, NULL, NULL, NULL, NULL}};
ConfigEntry config_entry_2p[] = {
    // 2 pass
    {SINGLE_INPUT, NULL, OUTPUT_STAT_FILE_TOKEN, "First pass stat file output", set_output_stat_file},
    {SINGLE_INPUT,
     NULL,
...
ConfigEntry config_entry_intra_refresh[] = {
    // File I/O
    {SINGLE_INPUT, NULL, INTRA_PERIOD_TOKEN, "Intra period interval(frames)", set_cfg_intra_period},
    {SINGLE_INPUT,
     NULL,
...
ConfigEntry config_entry_specific[] = {
    ...
    {SINGLE_INPUT, NULL, BASE_LAYER_SWITCH_MODE_TOKEN, "BaseLayerSwitchMode", set_base_layer_switch_mode},
    {SINGLE_INPUT, NULL, ENCMODE_TOKEN, "Encoder mode/Preset used", set_enc_mode},
    {SINGLE_INPUT, NULL, ENCODER_BIT_DEPTH, "Bit depth for codec(8 or 10)", set_encoder_bit_depth},
    {SINGLE_INPUT, NULL, ENCODER_COLOR_FORMAT, "EncoderColorFormat", set_encoder_color_format},
    {SINGLE_INPUT, NULL, QP_FILE_TOKEN, "Qp filename", set_cfg_qp_file},
    {SINGLE_INPUT,
     NULL,
    ...
    // DLF
    {SINGLE_INPUT, NULL, LOOP_FILTER_DISABLE_TOKEN, "Disable loop filter", set_disable_dlf_flag},
    // RESTORATION
    {SINGLE_INPUT,
     NULL,
    ...
    {SINGLE_INPUT, NULL, SUBPEL_TOKEN, "Subpel", set_enable_sub_pel_flag},
    {SINGLE_INPUT,
     NULL,
     OVR_BNDRY_BLK_TOKEN,
    ...
    // CHROMA
    {SINGLE_INPUT, NULL, CHROMA_MODE_TOKEN, "Select chroma mode", set_chroma_mode},
    // LOCAL WARPED MOTION
    {SINGLE_INPUT,
     NULL,
    ...
    // OBMC
    {SINGLE_INPUT, NULL, OBMC_TOKEN, "Enable OBMC (0: false, 1: true (default))", set_enable_obmc_flag},
    // RDOQ
    {SINGLE_INPUT, NULL, RDOQ_TOKEN, "Enable RDOQ (0 = OFF, 1 = ON, -1 = DEFAULT)", set_enable_rdoq_flag},
    ...
    // PREDICTIVE ME
    {SINGLE_INPUT, NULL, PRED_ME_TOKEN, "Set predictive me level", set_predictive_me_flag},
    ...
    // COMPOUND MODE
    {SINGLE_INPUT, NULL, COMPOUND_LEVEL_TOKEN, "Set compound mode", set_compound_level_flag},
    ...
    {SINGLE_INPUT, NULL, HME_ENABLE_TOKEN, "Enable HME (0 = OFF, 1 = ON)", set_enable_hme_flag},
    {SINGLE_INPUT,
     NULL,
     HME_L0_ENABLE_TOKEN,
    ...
    {SINGLE_INPUT, NULL, HDR_INPUT_TOKEN, "Enable high dynamic range", set_high_dynamic_range_input},
    // Latency
    {SINGLE_INPUT, NULL, INJECTOR_TOKEN, "Enable injector", set_injector},
    {SINGLE_INPUT, NULL, INJECTOR_FRAMERATE_TOKEN, "Set injector frame rate", set_injector_frame_rate},
    {SINGLE_INPUT, NULL, SPEED_CONTROL_TOKEN, "Enable speed control", speed_control_flag},
    // Annex A parameters
    {SINGLE_INPUT, NULL, PROFILE_TOKEN, "Bitstream profile number to use", set_profile},
    {SINGLE_INPUT, NULL, FILM_GRAIN_TOKEN, "Enable film grain", set_cfg_film_grain},
    // HME
    {ARRAY_INPUT,
     NULL,
     HME_LEVEL0_WIDTH,
    ...
    // --- start: ALTREF_FILTERING_SUPPORT
    {SINGLE_INPUT, NULL, ENABLE_ALTREFS, "Enable automatic alt reference frames", set_enable_altrefs},
    {SINGLE_INPUT, NULL, ALTREF_STRENGTH, "AltRef filter strength", set_altref_strength},
    {SINGLE_INPUT, NULL, ALTREF_NFRAMES, "AltRef max frames", set_altref_n_frames},
    {SINGLE_INPUT, NULL, ENABLE_OVERLAYS, "Enable overlays", set_enable_overlays},
    // --- end: ALTREF_FILTERING_SUPPORT

    {SINGLE_INPUT, NULL, SQ_WEIGHT_TOKEN, "Set square weight", set_square_weight},
    {SINGLE_INPUT, NULL, ENABLE_AMP_TOKEN, "Auto max partition", set_enable_auto_max_partition},

    {SINGLE_INPUT, NULL, MDS1_PRUNE_C_TH, "Set MD stage1 prune class threshold", set_mds1_prune_c_th},
    {SINGLE_INPUT, NULL, MDS1_PRUNE_S_TH, "Set MD stage1 prune candidate threshold", set_mds1_prune_s_th},
    {SINGLE_INPUT, NULL, MDS2_PRUNE_C_TH, "Set MD stage2 prune class threshold", set_mds2_prune_c_th},
    {SINGLE_INPUT,
     NULL,
     MDS2_PRUNE_S_TH,
...
ConfigEntry config_entry[] = {
    // File I/O
    {SINGLE_INPUT, NULL, INPUT_FILE_TOKEN, "InputFile", set_cfg_input_file},
    {SINGLE_INPUT, NULL, OUTPUT_BITSTREAM_TOKEN, "Output filename", set_cfg_stream_file},
    {SINGLE_INPUT, NULL, ERROR_FILE_TOKEN, "ErrorFile", set_cfg_error_file},
    {SINGLE_INPUT, NULL, OUTPUT_RECON_TOKEN, "ReconFile", set_cfg_recon_file},
    {SINGLE_INPUT, NULL, QP_FILE_TOKEN, "QpFile", set_cfg_qp_file},
    {SINGLE_INPUT, NULL, STAT_FILE_TOKEN, "StatFile", set_cfg_stat_file},
    {SINGLE_INPUT, NULL, INPUT_STAT_FILE_TOKEN, "input_stat_file", set_input_stat_file},
    {SINGLE_INPUT, NULL, OUTPUT_STAT_FILE_TOKEN, "output_stat_file", set_output_stat_file},
    // Picture Dimensions
    {SINGLE_INPUT, NULL, WIDTH_TOKEN, "Frame width", set_cfg_source_width},
    {SINGLE_INPUT, NULL, HEIGHT_TOKEN, "Frame height", set_cfg_source_height},
    // Prediction Structure
    {SINGLE_INPUT,
     NULL,
     ...
     "Stop encoding after n input frames",
     set_cfg_frames_to_be_encoded},
    {SINGLE_INPUT, NULL, BUFFERED_INPUT_TOKEN, "BufferedInput", set_buffered_input},
    {SINGLE_INPUT, NULL, BASE_LAYER_SWITCH_MODE_TOKEN, "BaseLayerSwitchMode", set_base_layer_switch_mode},
    {SINGLE_INPUT, NULL, ENCMODE_TOKEN, "EncoderMode", set_enc_mode},
    {SINGLE_INPUT, NULL, ENCMODE2P_TOKEN, "EncoderMode2p", set_snd_pass_enc_mode},
    {SINGLE_INPUT, NULL, INTRA_PERIOD_TOKEN, "IntraPeriod", set_cfg_intra_period},
    {SINGLE_INPUT, NULL, INTRA_REFRESH_TYPE_TOKEN, "IntraRefreshType", set_cfg_intra_refresh_type},
    {SINGLE_INPUT, NULL, FRAME_RATE_TOKEN, "Stream frame rate (rate/scale)", set_frame_rate},
    {SINGLE_INPUT, NULL, FRAME_RATE_NUMERATOR_TOKEN, "FrameRateNumerator", set_frame_rate_numerator},
    {SINGLE_INPUT,
     NULL,
     FRAME_RATE_DENOMINATOR_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     set_compressed_ten_bit_format},
    {SINGLE_INPUT, NULL, HIERARCHICAL_LEVELS_TOKEN, "HierarchicalLevels", set_hierarchical_levels},
    {SINGLE_INPUT, NULL, PRED_STRUCT_TOKEN, "PredStructure", set_cfg_pred_structure},
    {SINGLE_INPUT, NULL, TILE_ROW_TOKEN, "Number of tile rows to use, log2", set_tile_row},
    {SINGLE_INPUT, NULL, TILE_COL_TOKEN, "Number of tile columns to use, log2", set_tile_col},
    // Rate Control
    {SINGLE_INPUT,
    ...
    {SINGLE_INPUT, NULL, QP_TOKEN, "Constant/Constrained Quality level", set_cfg_qp},
    {SINGLE_INPUT, NULL, USE_QP_FILE_TOKEN, "UseQpFile", set_cfg_use_qp_file},
    {SINGLE_INPUT, NULL, STAT_REPORT_TOKEN, "StatReport", set_stat_report},
    {SINGLE_INPUT, NULL, RATE_CONTROL_ENABLE_TOKEN, "Rate control mode", set_rate_control_mode},
    {SINGLE_INPUT, NULL, LOOK_AHEAD_DIST_TOKEN, "LookAheadDistance", set_look_ahead_distance},
    {SINGLE_INPUT, NULL, TARGET_BIT_RATE_TOKEN, "Target Bitrate (kbps)", set_target_bit_rate},
    {SINGLE_INPUT, NULL, MAX_QP_TOKEN, "Maximum (worst) quantizer", set_max_qp_allowed},
    {SINGLE_INPUT, NULL, MIN_QP_TOKEN, "Minimum (best) quantizer", set_min_qp_allowed},
    {SINGLE_INPUT, NULL, VBV_BUFSIZE_TOKEN, "VBVBufSize", set_vbv_buf_size},
    {SINGLE_INPUT, NULL, ADAPTIVE_QP_ENABLE_TOKEN, "AdaptiveQuantization", set_adaptive_quantization},

    // DLF
    {SINGLE_INPUT, NULL, LOOP_FILTER_DISABLE_TOKEN, "LoopFilterDisable", set_disable_dlf_flag},
    ...
    {SINGLE_INPUT, NULL, MFMV_ENABLE_TOKEN, "Mfmv", set_enable_mfmv_flag},
    {SINGLE_INPUT, NULL, REDUNDANT_BLK_TOKEN, "RedundantBlock", set_enable_redundant_blk_flag},
    {SINGLE_INPUT,
     NULL,
     TRELLIS_ENABLE_TOKEN,
     "Disable trellis optimization of quantized coefficients (0: false 1: true  2: true for rd "
     "search 3: true for estimate yrd serch (default))",
     set_enable_trellis_flag},
    {SINGLE_INPUT, NULL, SPATIAL_SSE_FL_TOKEN, "SpatialSSEfl", set_spatial_sse_fl_flag},
    {SINGLE_INPUT, NULL, SUBPEL_TOKEN, "Subpel", set_enable_sub_pel_flag},
    {SINGLE_INPUT, NULL, OVR_BNDRY_BLK_TOKEN, "OverBoundryBlock", set_over_bndry_blk_flag},
    {SINGLE_INPUT,
     NULL,
     NEW_NEAREST_COMB_INJECT_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     set_nx4_4xn_parent_mv_inject_flag},
    {SINGLE_INPUT, NULL, PRUNE_UNIPRED_ME_TOKEN, "PruneUnipredMe", set_prune_unipred_me_flag},
    {SINGLE_INPUT, NULL, PRUNE_REF_REC_PART_TOKEN, "PruneRefRecPart", set_prune_ref_rec_part_flag},
    {SINGLE_INPUT, NULL, NSQ_TABLE_TOKEN, "NsqTable", set_nsq_table_flag},
    {SINGLE_INPUT, NULL, FRAME_END_CDF_UPDATE_TOKEN, "FrameEndCdfUpdate", set_frame_end_cdf_update_flag},

    // CHROMA
    {SINGLE_INPUT, NULL, CHROMA_MODE_TOKEN, "ChromaMode", set_chroma_mode},
    ...
    // CLASS 12
    {SINGLE_INPUT, NULL, CLASS_12_TOKEN, "CombineClass12", set_class_12_flag},
    // EDGE SKIP ANGLE INTRA
    {SINGLE_INPUT,
     NULL,
     EDGE_SKIP_ANGLE_INTRA_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     set_interintra_compound_flag},
    // FRACTIONAL SEARCH 64x64
    {SINGLE_INPUT, NULL, FRAC_SEARCH_64_TOKEN, "FractionalSearch64", set_fractional_search_64_flag},

    // OBMC
    {SINGLE_INPUT, NULL, OBMC_TOKEN, "Enable OBMC (0: false, 1: true (default))", set_enable_obmc_flag},
    // RDOQ
    {SINGLE_INPUT, NULL, RDOQ_TOKEN, "RDOQ", set_enable_rdoq_flag},
    ...
    // PREDICTIVE ME
    {SINGLE_INPUT, NULL, PRED_ME_TOKEN, "PredMe", set_predictive_me_flag},
    // BIPRED 3x3 INJECTION
    {SINGLE_INPUT, NULL, BIPRED_3x3_TOKEN, "Bipred3x3", set_bipred3x3inject_flag},
    // COMPOUND MODE
    {SINGLE_INPUT, NULL, COMPOUND_LEVEL_TOKEN, "CompoundLevel", set_compound_level_flag},

    // ME Tools
    {SINGLE_INPUT, NULL, USE_DEFAULT_ME_HME_TOKEN, "UseDefaultMeHme", set_cfg_use_default_me_hme},
    {SINGLE_INPUT, NULL, HME_ENABLE_TOKEN, "HME", set_enable_hme_flag},
    {SINGLE_INPUT, NULL, HME_L0_ENABLE_TOKEN, "HMELevel0", set_enable_hme_level_0_flag},
    {SINGLE_INPUT, NULL, HME_L1_ENABLE_TOKEN, "HMELevel1", set_enable_hme_level_1_flag},
    {SINGLE_INPUT, NULL, HME_L2_ENABLE_TOKEN, "HMELevel2", set_enable_hme_level_2_flag},
    {SINGLE_INPUT, NULL, EXT_BLOCK, "ExtBlockFlag", set_enable_ext_block_flag},
    // ME Parameters
    {SINGLE_INPUT, NULL, SEARCH_AREA_WIDTH_TOKEN, "SearchAreaWidth", set_cfg_search_area_width},
    {SINGLE_INPUT, NULL, SEARCH_AREA_HEIGHT_TOKEN, "SearchAreaHeight", set_cfg_search_area_height},
    // HME Parameters
    {SINGLE_INPUT,
     NULL,
     NUM_HME_SEARCH_WIDTH_TOKEN,
    ...
    {SINGLE_INPUT,
     ...
     set_cfg_hme_level_0_total_search_area_height},
    // MD Parameters
    {SINGLE_INPUT, NULL, SCREEN_CONTENT_TOKEN, "ScreenContentMode", set_screen_content_mode},
    {SINGLE_INPUT, NULL, HBD_MD_ENABLE_TOKEN, "HighBitDepthModeDecision", set_enable_hbd_mode_decision},
    {SINGLE_INPUT,
     NULL,
     PALETTE_TOKEN,
     "Enable palette prediction mode (0: false, 1: true (default))",
     set_enable_palette},
    {SINGLE_INPUT, NULL, OLPD_REFINEMENT_TOKEN, "OlpdRefinement", set_enable_olpd_refinement},
    // Thread Management
    {SINGLE_INPUT, NULL, THREAD_MGMNT, "LogicalProcessors", set_logical_processors},
    {SINGLE_INPUT, NULL, UNPIN_LP1_TOKEN, "UnpinSingleCoreExecution", set_unpin_single_core_execution},
    {SINGLE_INPUT, NULL, TARGET_SOCKET, "TargetSocket", set_target_socket},
    // Optional Features
    {SINGLE_INPUT,
     NULL,
     UNRESTRICTED_MOTION_VECTOR,
    ...
    //    { SINGLE_INPUT, BITRATE_REDUCTION_TOKEN, "bit_rate_reduction", SetBitRateReduction },
    {SINGLE_INPUT, NULL, HDR_INPUT_TOKEN, "HighDynamicRangeInput", set_high_dynamic_range_input},
    // Latency
    {SINGLE_INPUT, NULL, INJECTOR_TOKEN, "Injector", set_injector},
    {SINGLE_INPUT, NULL, INJECTOR_FRAMERATE_TOKEN, "InjectorFrameRate", set_injector_frame_rate},
    {SINGLE_INPUT, NULL, SPEED_CONTROL_TOKEN, "speed_control_flag", speed_control_flag},
    // Annex A parameters
    {SINGLE_INPUT, NULL, PROFILE_TOKEN, "Bitstream profile number to use", set_profile},
    {SINGLE_INPUT, NULL, TIER_TOKEN, "Tier", set_tier},
    {SINGLE_INPUT, NULL, LEVEL_TOKEN, "Level", set_level},
    {SINGLE_INPUT, NULL, LATENCY_MODE, "LatencyMode", set_latency_mode},
    {SINGLE_INPUT, NULL, FILM_GRAIN_TOKEN, "FilmGrain", set_cfg_film_grain},
    // Asm Type
    {SINGLE_INPUT, NULL, ASM_TYPE_TOKEN, "Asm", set_asm_type},
    // HME
    {ARRAY_INPUT,
     NULL,
     HME_LEVEL0_WIDTH,
    ...
    {ARRAY_INPUT,
     ...
     set_hme_level_2_search_area_in_height_array},
    // --- start: ALTREF_FILTERING_SUPPORT
    {SINGLE_INPUT, NULL, ENABLE_ALTREFS, "EnableAltRefs", set_enable_altrefs},
    {SINGLE_INPUT, NULL, ALTREF_STRENGTH, "AltRef filter strength", set_altref_strength},
    {SINGLE_INPUT, NULL, ALTREF_NFRAMES, "AltRef max frames", set_altref_n_frames},
    {SINGLE_INPUT, NULL, ENABLE_OVERLAYS, "EnableOverlays", set_enable_overlays},
    // --- end: ALTREF_FILTERING_SUPPORT

    {SINGLE_INPUT, NULL, SQ_WEIGHT_TOKEN, "SquareWeight", set_square_weight},
    {SINGLE_INPUT, NULL, ENABLE_AMP_TOKEN, "AutomaxPartition", set_enable_auto_max_partition},

    {SINGLE_INPUT, NULL, MDS1_PRUNE_C_TH, "MDStage1PruneClassThreshold", set_mds1_prune_c_th},
    {SINGLE_INPUT, NULL, MDS1_PRUNE_S_TH, "MDStage1PruneCandThreshold", set_mds1_prune_s_th},
    {SINGLE_INPUT, NULL, MDS2_PRUNE_C_TH, "MDStage2PruneClassThreshold", set_mds2_prune_c_th},
    {SINGLE_INPUT, NULL, MDS2_PRUNE_S_TH, "MDStage2PruneCandThreshold", set_mds2_prune_s_th},
