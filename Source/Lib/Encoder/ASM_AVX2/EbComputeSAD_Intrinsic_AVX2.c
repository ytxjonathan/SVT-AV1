...
#define SEARCH_CALC_BEST_16BIT(a, b, best, best_mv) \
    ...
    for (int pos = 0; pos < 31; pos += 4) {
        ...
        __m128i       best_sad16x8 = _mm_loadu_si128((__m128i *)&(p_best_sad_16x8[pos]));
        const __m128i mask         = _mm_cmplt_epi32(sad16x8, best_sad16x8);
        best_sad16x8               = _mm_min_epi32(best_sad16x8, sad16x8);
        _mm_storeu_si128((__m128i *)&(p_best_sad_16x8[pos]), best_sad16x8);
    ...
    for (int pos = 0; pos < 31; pos += 4) {
        ...
        __m128i       best_sad8x16 = _mm_loadu_si128((__m128i *)&(p_best_sad_8x16[pos]));
        const __m128i mask         = _mm_cmplt_epi32(sad8x16, best_sad8x16);
        best_sad8x16               = _mm_min_epi32(best_sad8x16, sad8x16);
        _mm_storeu_si128((__m128i *)&(p_best_sad_8x16[pos]), best_sad8x16);
    ...
    SEARCH_CALC_BEST_16BIT(sad_16x8[0], sad_16x8[2], p_best_sad_32x8[0], p_best_mv32x8[0]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[1], sad_16x8[3], p_best_sad_32x8[1], p_best_mv32x8[1]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[4], sad_16x8[6], p_best_sad_32x8[2], p_best_mv32x8[2]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[5], sad_16x8[7], p_best_sad_32x8[3], p_best_mv32x8[3]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[8], sad_16x8[10], p_best_sad_32x8[4], p_best_mv32x8[4]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[9], sad_16x8[11], p_best_sad_32x8[5], p_best_mv32x8[5]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[12], sad_16x8[14], p_best_sad_32x8[6], p_best_mv32x8[6]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[13], sad_16x8[15], p_best_sad_32x8[7], p_best_mv32x8[7]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[16], sad_16x8[18], p_best_sad_32x8[8], p_best_mv32x8[8]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[17], sad_16x8[19], p_best_sad_32x8[9], p_best_mv32x8[9]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[20], sad_16x8[22], p_best_sad_32x8[10], p_best_mv32x8[10]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[21], sad_16x8[23], p_best_sad_32x8[11], p_best_mv32x8[11]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[24], sad_16x8[26], p_best_sad_32x8[12], p_best_mv32x8[12]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[25], sad_16x8[27], p_best_sad_32x8[13], p_best_mv32x8[13]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[28], sad_16x8[30], p_best_sad_32x8[14], p_best_mv32x8[14]);
    SEARCH_CALC_BEST_16BIT(sad_16x8[29], sad_16x8[31], p_best_sad_32x8[15], p_best_mv32x8[15]);

    SEARCH_CALC_BEST_16BIT(sad_8x16[0], sad_8x16[4], p_best_sad_8x32[0], p_best_mv8x32[0]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[1], sad_8x16[5], p_best_sad_8x32[1], p_best_mv8x32[1]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[2], sad_8x16[6], p_best_sad_8x32[2], p_best_mv8x32[2]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[3], sad_8x16[7], p_best_sad_8x32[3], p_best_mv8x32[3]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[8], sad_8x16[12], p_best_sad_8x32[4], p_best_mv8x32[4]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[9], sad_8x16[13], p_best_sad_8x32[5], p_best_mv8x32[5]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[10], sad_8x16[14], p_best_sad_8x32[6], p_best_mv8x32[6]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[11], sad_8x16[15], p_best_sad_8x32[7], p_best_mv8x32[7]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[16], sad_8x16[20], p_best_sad_8x32[8], p_best_mv8x32[8]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[17], sad_8x16[21], p_best_sad_8x32[9], p_best_mv8x32[9]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[18], sad_8x16[22], p_best_sad_8x32[10], p_best_mv8x32[10]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[19], sad_8x16[23], p_best_sad_8x32[11], p_best_mv8x32[11]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[24], sad_8x16[28], p_best_sad_8x32[12], p_best_mv8x32[12]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[25], sad_8x16[29], p_best_sad_8x32[13], p_best_mv8x32[13]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[26], sad_8x16[30], p_best_sad_8x32[14], p_best_mv8x32[14]);
    SEARCH_CALC_BEST_16BIT(sad_8x16[27], sad_8x16[31], p_best_sad_8x32[15], p_best_mv8x32[15]);
