...
int32_t eb_av1_loop_restoration_corners_in_sb(Av1Common *cm, int32_t plane, int32_t mi_row,
    ...
    /*!< Compute the mi-unit corners of the superblock relative to the top-left of the tile */
...
EbErrorType eb_av1_alloc_restoration_buffers(Av1Common *cm) {
    ...
    /*!< Now we need to allocate enough space to store the line buffers for the stripes */
