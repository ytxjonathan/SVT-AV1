...
/*!< Declare some of the forward non-vectorized transforms which
 *   are used in some of the vectorized implementations */
...
#define GEN_FFT_16(ret, suffix, T, T_VEC, load, store, constant, add, sub, mul)                  \
    ret eb_aom_fft1d_16_##suffix(const T *input, T *output, int32_t stride) {                    \
        ...
        const T_VEC w18[2]    = {sub(w1, mul(k_weight2, sub(w8, w10))),                          \
        ...
        const T_VEC w37[2]    = {sub(w20, mul(k_weight2, sub(w27, w29))),                        \
        ...
        store(output + 7 * stride,                                                               \
              add(w16[0], sub(sub(k_weight0, mul(k_weight3, w35[0])), mul(k_weight4, w35[1])))); \
...
#define GEN_FFT_32(ret, suffix, T, T_VEC, load, store, constant, add, sub, mul)                     \
    ret eb_aom_fft1d_32_##suffix(const T *input, T *output, int32_t stride) {                       \
        ...
        const T_VEC w65[2] = {sub(w48, mul(k_weight2, sub(w55, w57))),                              \
        ...
        const T_VEC w84[2] = {sub(w67, mul(k_weight2, sub(w74, w76))),                              \
        ...
        const T_VEC w91[2] = {                                                                      \
            add(w65[0], sub(sub(k_weight0, mul(k_weight4, w84[0])), mul(k_weight3, w84[1]))),       \
            sub(sub(k_weight0, w65[1]), sub(mul(k_weight3, w84[0]), mul(k_weight4, w84[1])))};      \
        const T_VEC w92[2] = {sub(w52, mul(k_weight2, sub(w71, w78))),                              \
                              sub(w59, mul(k_weight2, add(w78, w71)))};                             \
        const T_VEC w93[2] = {                                                                      \
            add(w63[0], sub(sub(k_weight0, mul(k_weight3, w82[0])), mul(k_weight4, w82[1]))),       \
            sub(sub(k_weight0, w63[1]), sub(mul(k_weight4, w82[0]), mul(k_weight3, w82[1])))};      \
        store(output + 0 * stride, add(w38, w85));                                                  \
        store(output + 1 * stride,                                                                  \
              add(w40[0], add(mul(k_weight5, w87[0]), mul(k_weight6, w87[1]))));                    \
        store(output + 2 * stride,                                                                  \
              add(w41[0], add(mul(k_weight3, w88[0]), mul(k_weight4, w88[1]))));                    \
        store(output + 3 * stride,                                                                  \
              add(w42[0], add(mul(k_weight7, w89[0]), mul(k_weight8, w89[1]))));                    \
        store(output + 4 * stride, add(w15, mul(k_weight2, sub(w62, w81))));                        \
        store(output + 5 * stride,                                                                  \
              add(w44[0], add(mul(k_weight8, w91[0]), mul(k_weight7, w91[1]))));                    \
        store(output + 6 * stride,                                                                  \
              add(w45[0], add(mul(k_weight4, w92[0]), mul(k_weight3, w92[1]))));                    \
        store(output + 7 * stride,                                                                  \
              add(w46[0], add(mul(k_weight6, w93[0]), mul(k_weight5, w93[1]))));                    \
        store(output + 8 * stride, w39);                                                            \
        store(output + 9 * stride,                                                                  \
              add(w46[0], sub(sub(k_weight0, mul(k_weight6, w93[0])), mul(k_weight5, w93[1]))));    \
        store(output + 10 * stride,                                                                 \
              add(w45[0], sub(sub(k_weight0, mul(k_weight4, w92[0])), mul(k_weight3, w92[1]))));    \
        store(output + 11 * stride,                                                                 \
              add(w44[0], sub(sub(k_weight0, mul(k_weight8, w91[0])), mul(k_weight7, w91[1]))));    \
        store(output + 12 * stride, sub(w15, mul(k_weight2, sub(w62, w81))));                       \
        store(output + 13 * stride,                                                                 \
              add(w42[0], sub(sub(k_weight0, mul(k_weight7, w89[0])), mul(k_weight8, w89[1]))));    \
        store(output + 14 * stride,                                                                 \
              add(w41[0], sub(sub(k_weight0, mul(k_weight3, w88[0])), mul(k_weight4, w88[1]))));    \
        store(output + 15 * stride,                                                                 \
              add(w40[0], sub(sub(k_weight0, mul(k_weight5, w87[0])), mul(k_weight6, w87[1]))));    \
        store(output + 16 * stride, sub(w38, w85));                                                 \
        store(output + 17 * stride,                                                                 \
              add(w40[1], sub(mul(k_weight5, w87[1]), mul(k_weight6, w87[0]))));                    \
        store(output + 18 * stride,                                                                 \
              add(w41[1], sub(mul(k_weight3, w88[1]), mul(k_weight4, w88[0]))));                    \
        store(output + 19 * stride,                                                                 \
              add(w42[1], sub(mul(k_weight7, w89[1]), mul(k_weight8, w89[0]))));                    \
        store(output + 20 * stride, sub(sub(k_weight0, w34), mul(k_weight2, add(w81, w62))));       \
        store(output + 21 * stride,                                                                 \
              add(w44[1], sub(mul(k_weight8, w91[1]), mul(k_weight7, w91[0]))));                    \
        store(output + 22 * stride,                                                                 \
              add(w45[1], sub(mul(k_weight4, w92[1]), mul(k_weight3, w92[0]))));                    \
        store(output + 23 * stride,                                                                 \
              add(w46[1], sub(mul(k_weight6, w93[1]), mul(k_weight5, w93[0]))));                    \
        store(output + 24 * stride, sub(k_weight0, w86));                                           \
        store(output + 25 * stride,                                                                 \
              sub(sub(k_weight0, w46[1]), sub(mul(k_weight5, w93[0]), mul(k_weight6, w93[1]))));    \
        store(output + 26 * stride,                                                                 \
              sub(sub(k_weight0, w45[1]), sub(mul(k_weight3, w92[0]), mul(k_weight4, w92[1]))));    \
        store(output + 27 * stride,                                                                 \
              sub(sub(k_weight0, w44[1]), sub(mul(k_weight7, w91[0]), mul(k_weight8, w91[1]))));    \
        store(output + 28 * stride, sub(w34, mul(k_weight2, add(w81, w62))));                       \
        store(output + 29 * stride,                                                                 \
              sub(sub(k_weight0, w42[1]), sub(mul(k_weight8, w89[0]), mul(k_weight7, w89[1]))));    \
        store(output + 30 * stride,                                                                 \
              sub(sub(k_weight0, w41[1]), sub(mul(k_weight4, w88[0]), mul(k_weight3, w88[1]))));    \
        store(output + 31 * stride,                                                                 \
              sub(sub(k_weight0, w40[1]), sub(mul(k_weight6, w87[0]), mul(k_weight5, w87[1]))));    \
    }
...
#define GEN_IFFT_8(ret, suffix, T, T_VEC, load, store, constant, add, sub, mul)                  \
    ret eb_aom_ifft1d_8_##suffix(const T *input, T *output, int32_t stride) {                    \
        ...
        store(output + 5 * stride,                                                               \
              add(w12[0], sub(sub(k_weight0, mul(k_weight2, w20[0])), mul(k_weight2, w20[1])))); \
...
#define GEN_IFFT_16(ret, suffix, T, T_VEC, load, store, constant, add, sub, mul)                 \
    ret eb_aom_ifft1d_16_##suffix(const T *input, T *output, int32_t stride) {                   \
        ...
        const T_VEC w57[2] = {                                                                   \
            add(w44[0], sub(sub(k_weight0, mul(k_weight2, w52[0])), mul(k_weight2, w52[1]))),    \
        ...
        store(output + 1 * stride,                                                               \
              add(w32[0], add(mul(k_weight3, w56[0]), mul(k_weight4, w56[1]))));                 \
        store(output + 2 * stride, add(w34[0], mul(k_weight2, add(w58[0], w58[1]))));            \
        store(output + 3 * stride,                                                               \
              add(w36[0], add(mul(k_weight4, w60[0]), mul(k_weight3, w60[1]))));                 \
        store(output + 4 * stride, add(w31[0], w55[1]));                                         \
        store(output + 5 * stride,                                                               \
              sub(w33[0], sub(mul(k_weight4, w57[0]), mul(k_weight3, w57[1]))));                 \
        store(output + 6 * stride, sub(w35[0], mul(k_weight2, sub(w59[0], w59[1]))));            \
        store(output + 7 * stride,                                                               \
              sub(w37[0], sub(mul(k_weight3, w61[0]), mul(k_weight4, w61[1]))));                 \
        store(output + 8 * stride, sub(w30[0], w54[0]));                                         \
        store(output + 9 * stride,                                                               \
              add(w32[0], sub(sub(k_weight0, mul(k_weight3, w56[0])), mul(k_weight4, w56[1])))); \
        store(output + 10 * stride,                                                              \
              add(w34[0], sub(sub(k_weight0, mul(k_weight2, w58[0])), mul(k_weight2, w58[1])))); \
        store(output + 11 * stride,                                                              \
              add(w36[0], sub(sub(k_weight0, mul(k_weight4, w60[0])), mul(k_weight3, w60[1])))); \
        store(output + 12 * stride, sub(w31[0], w55[1]));                                        \
        store(output + 13 * stride,                                                              \
              add(w33[0], sub(mul(k_weight4, w57[0]), mul(k_weight3, w57[1]))));                 \
...
#define GEN_IFFT_32(ret, suffix, T, T_VEC, load, store, constant, add, sub, mul)                   \
    ret eb_aom_ifft1d_32_##suffix(const T *input, T *output, int32_t stride) {                     \
        ...
        const T_VEC w73[2] = {                                                                     \
            add(w60[0], sub(sub(k_weight0, mul(k_weight2, w68[0])), mul(k_weight2, w68[1]))),      \
        ...
        const T_VEC w81[2] = {                                                                     \
            add(w48[0], sub(sub(k_weight0, mul(k_weight3, w72[0])), mul(k_weight4, w72[1]))),      \
        ...
        const T_VEC w83[2] = {                                                                     \
            add(w50[0], sub(sub(k_weight0, mul(k_weight2, w74[0])), mul(k_weight2, w74[1]))),      \
        ...
        const T_VEC w85[2] = {                                                                     \
            add(w52[0], sub(sub(k_weight0, mul(k_weight4, w76[0])), mul(k_weight3, w76[1]))),      \
        ...
        const T_VEC w113[2] = {                                                                    \
            add(w100[0], sub(sub(k_weight0, mul(k_weight2, w108[0])), mul(k_weight2, w108[1]))),   \
        ...
        const T_VEC w137[2] = {                                                                    \
            add(w124[0], sub(sub(k_weight0, mul(k_weight2, w132[0])), mul(k_weight2, w132[1]))),   \
        ...
        const T_VEC w144[2] = {                                                                    \
            add(w112[0], add(mul(k_weight3, w136[0]), mul(k_weight4, w136[1]))),                   \
            add(w112[1], sub(mul(k_weight3, w136[1]), mul(k_weight4, w136[0])))};                  \
        const T_VEC w145[2] = {                                                                    \
            add(w112[0], sub(sub(k_weight0, mul(k_weight3, w136[0])), mul(k_weight4, w136[1]))),   \
        ...
        const T_VEC w147[2] = {                                                                    \
            add(w114[0], sub(sub(k_weight0, mul(k_weight2, w138[0])), mul(k_weight2, w138[1]))),   \
            add(w114[1], mul(k_weight2, sub(w138[0], w138[1])))};                                  \
        const T_VEC w148[2] = {                                                                    \
            add(w116[0], add(mul(k_weight4, w140[0]), mul(k_weight3, w140[1]))),                   \
            add(w116[1], sub(mul(k_weight4, w140[1]), mul(k_weight3, w140[0])))};                  \
        const T_VEC w149[2] = {                                                                    \
            add(w116[0], sub(sub(k_weight0, mul(k_weight4, w140[0])), mul(k_weight3, w140[1]))),   \
        ...
        const T_VEC w152[2] = {                                                                    \
            sub(w113[0], sub(mul(k_weight4, w137[0]), mul(k_weight3, w137[1]))),                   \
            add(w113[1], sub(sub(k_weight0, mul(k_weight4, w137[1])), mul(k_weight3, w137[0])))};  \
        const T_VEC w153[2] = {                                                                    \
            add(w113[0], sub(mul(k_weight4, w137[0]), mul(k_weight3, w137[1]))),                   \
        ...
        const T_VEC w156[2] = {                                                                    \
            sub(w117[0], sub(mul(k_weight3, w141[0]), mul(k_weight4, w141[1]))),                   \
            add(w117[1], sub(sub(k_weight0, mul(k_weight3, w141[1])), mul(k_weight4, w141[0])))};  \
        const T_VEC w157[2] = {                                                                    \
            add(w117[0], sub(mul(k_weight3, w141[0]), mul(k_weight4, w141[1]))),                   \
            add(w117[1], add(mul(k_weight3, w141[1]), mul(k_weight4, w141[0])))};                  \
        store(output + 0 * stride, add(w78[0], w142[0]));                                          \
        store(output + 1 * stride,                                                                 \
              add(w80[0], add(mul(k_weight5, w144[0]), mul(k_weight6, w144[1]))));                 \
        store(output + 2 * stride,                                                                 \
              add(w82[0], add(mul(k_weight3, w146[0]), mul(k_weight4, w146[1]))));                 \
        store(output + 3 * stride,                                                                 \
              add(w84[0], add(mul(k_weight7, w148[0]), mul(k_weight8, w148[1]))));                 \
        store(output + 4 * stride, add(w86[0], mul(k_weight2, add(w150[0], w150[1]))));            \
        store(output + 5 * stride,                                                                 \
              add(w88[0], add(mul(k_weight8, w152[0]), mul(k_weight7, w152[1]))));                 \
        store(output + 6 * stride,                                                                 \
              add(w90[0], add(mul(k_weight4, w154[0]), mul(k_weight3, w154[1]))));                 \
        store(output + 7 * stride,                                                                 \
              add(w92[0], add(mul(k_weight6, w156[0]), mul(k_weight5, w156[1]))));                 \
        store(output + 8 * stride, add(w79[0], w143[1]));                                          \
        store(output + 9 * stride,                                                                 \
              sub(w81[0], sub(mul(k_weight6, w145[0]), mul(k_weight5, w145[1]))));                 \
        store(output + 10 * stride,                                                                \
              sub(w83[0], sub(mul(k_weight4, w147[0]), mul(k_weight3, w147[1]))));                 \
        store(output + 11 * stride,                                                                \
              sub(w85[0], sub(mul(k_weight8, w149[0]), mul(k_weight7, w149[1]))));                 \
        store(output + 12 * stride, sub(w87[0], mul(k_weight2, sub(w151[0], w151[1]))));           \
        store(output + 13 * stride,                                                                \
              sub(w89[0], sub(mul(k_weight7, w153[0]), mul(k_weight8, w153[1]))));                 \
        store(output + 14 * stride,                                                                \
              sub(w91[0], sub(mul(k_weight3, w155[0]), mul(k_weight4, w155[1]))));                 \
        store(output + 15 * stride,                                                                \
              sub(w93[0], sub(mul(k_weight5, w157[0]), mul(k_weight6, w157[1]))));                 \
        ...
        store(output + 25 * stride,                                                                \
              add(w81[0], sub(mul(k_weight6, w145[0]), mul(k_weight5, w145[1]))));                 \
        store(output + 26 * stride,                                                                \
              add(w83[0], sub(mul(k_weight4, w147[0]), mul(k_weight3, w147[1]))));                 \
        store(output + 27 * stride,                                                                \
              add(w85[0], sub(mul(k_weight8, w149[0]), mul(k_weight7, w149[1]))));                 \
        store(output + 28 * stride, add(w87[0], mul(k_weight2, sub(w151[0], w151[1]))));           \
        store(output + 29 * stride,                                                                \
              add(w89[0], sub(mul(k_weight7, w153[0]), mul(k_weight8, w153[1]))));                 \
        store(output + 30 * stride,                                                                \
              add(w91[0], sub(mul(k_weight3, w155[0]), mul(k_weight4, w155[1]))));                 \
        store(output + 31 * stride,                                                                \
              add(w93[0], sub(mul(k_weight5, w157[0]), mul(k_weight6, w157[1]))));                 \
    }
