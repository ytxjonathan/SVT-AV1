...
/*!< The maximum number of steps in a step search
 *   given the largest allowed initial step */
...
/*!< Allowed motion vector pixel distance
 *   outside image border for Block_16x16 */
