...
/*!< here in and out pointers (x and d) should be different! we don't store their values inside */
...
/*!< here in and out pointers (x and d arrays) should be different! we don't store their values inside */
